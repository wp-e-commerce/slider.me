...
;(function ($) {
  ...
  $.flexslider2 = function(el, options) {
    ...
    // Get Targets for a specific slide index
    slider.getTargetFor = function(dir, current) {
      slider.direction = dir;
      if (dir === "next") {
        return (current === slider.last) ? 0 : current + 1;
      } else {
        return (current === 0) ? slider.last : current - 1;
      }
    }

    // Allow changing of slider options
