jQuery(document).ready( function ( e ) {
	...
	jQuery( '#slider_me-advanced-settings' ).hide();
	jQuery( 'a.advanced-settings' ).click( function ( e ) {
		jQuery( '#slider_me-advanced-settings' ).toggle();
	});
	...
	jQuery( 'form#slider_me-insert' ).submit( function ( e ) {
	var shortcode_atts = '';

	for ( var prop in slider_me_settings ) {
		if ( slider_me_settings.hasOwnProperty( prop ) ) {
			var defaultValue = slider_me_settings[prop];
	...
	var shortcode = '[slider_me' + shortcode_atts + '] ';
