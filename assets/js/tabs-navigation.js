jQuery(document).ready( function($) {
	...
	jQuery( '#slider_me .subsubsub a.tab' ).click( function ( e ) {
		...
		if ( jQuery( this ).hasClass( 'all' ) ) {
			jQuery( '#slider_me h3, #slider_me form p, #slider_me table.form-table, p.submit' ).show();
		...
		jQuery( '#slider_me h3, #slider_me form > p:not(".submit"), #slider_me table' ).hide();
