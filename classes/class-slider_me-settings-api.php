...
class SliderMe_Settings_API {
	...
	public function __construct () {
		$this->token = 'slider_me';
		$this->page_slug = 'slider_me-settings-api';
	...
	public function init_sections () {
		...
		_e( 'Override init_sections() in your class.', 'slider_me' );
	} // End init_sections()
	...
	public function init_fields () {
		...
		_e( 'Override init_fields() in your class.', 'slider_me' );
	} // End init_fields()
	...
	public function settings_tabs () {
		...
		if ( count( $this->tabs ) > 0 ) {
			...
			$sections = array(
						'all' => array( 'href' => '#all', 'name' => __( 'All', 'slider_me' ), 'class' => 'current all tab' )
					);
	...
	public function settings_screen () {
		global $slider_me;
?>
<div id="slider_me" class="wrap <?php echo esc_attr( $this->token ); ?>">
	<?php screen_icon( 'slider_me' ); ?>
...
<?php
	...
	protected function add_error ( $key, $data ) {
		if ( isset( $data['error_message'] ) ) {
			...
			$message = sprintf( __( '%s is a required field', 'slider_me' ), $data['name'] );
		}
	...
	protected function parse_errors () {
		if ( count ( $this->errors ) > 0 ) {
			...
			$message = sprintf( __( '%s updated', 'slider_me' ), $this->name );
	...
	public function enqueue_scripts () {
		global $slider_me;
		if ( $this->has_range ) {
			wp_enqueue_script( 'slider_me-settings-ranges', $slider_me->plugin_url . 'assets/js/ranges.js', array( 'jquery-ui-slider' ), '1.0.0' );
		}

		wp_register_script( 'slider_me-settings-imageselectors', $slider_me->plugin_url . 'assets/js/image-selectors.js', array( 'jquery' ), '1.0.0' );
		...
		if ( $this->has_tabs ) {
			wp_enqueue_script( 'slider_me-settings-tabs-navigation', $slider_me->plugin_url . 'assets/js/tabs-navigation.js', array( 'jquery' ), '1.0.0' );
		}
	} // End enqueue_scripts()
	...
	public function enqueue_styles () {
		global $slider_me;
		wp_enqueue_style( $slider_me->token . '-admin' );

		wp_enqueue_style( 'slider_me-settings-api', $slider_me->plugin_url . 'assets/css/settings.css', '', '1.0.0' );
	...
	public function enqueue_field_styles () {
		...
		if ( $this->has_range ) {
			wp_enqueue_style( 'slider_me-settings-ranges', $slider_me->plugin_url . 'assets/css/ranges.css', '', '1.0.0' );
		}

		wp_register_style( 'slider_me-settings-imageselectors', $slider_me->plugin_url . 'assets/css/image-selectors.css', '', '1.0.0' );
